package com.example.android.mygcmnetworkmanager;
...
public class SchedulerService extends GcmTaskService {
    ...
    private final String APP_ID = "11b6fbc8158286e158ba136028ae83dd";
    private final String CITY = "Tangerang";
    ...
    private void showNotification(Context applicationContext, String title, String message, int notifId) {
        ...
        String CHANNEL_NAME = "MyGCMNetworkManager channel";
